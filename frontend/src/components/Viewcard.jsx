...
const ViewCard = ({ firstName, primaryPhoto, age, sex, id, likes,myID }) => {
    // Create a URL for the joke beign displayed
    const newPath = "/view/" + id
    const editPath = "/update" + id
    const delPath = "/remove/" + id

    const [theLikes, setTheLikes] = useState(likes)
    const [allsex, setSex] = useState([])
    useEffect(() => {
        if ("m" == sex)
            setSex("bg-blue-300")
        else
    ...
    return (
        <div className={allsex}>

            <Link to={newPath} className="flex flex-col items-center border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-xl hover:bg-gray-100">
                ...
                <div className="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900"> {age} </h5>
            ...
            <LikesBar likes={theLikes} setLikes={setTheLikes} myID={myID} />
