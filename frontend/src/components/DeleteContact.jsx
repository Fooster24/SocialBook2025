...
const Delete = () => {
    ...
    let handleDelete = () => {
        const dataReq = new Request('http://localhost:13590/remove/_id/' + myID.id,
            {
                method: "DELETE",
                headers: {
        ...
        <div id="modelConfirm" className="fixed z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 ">
            <div className="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
                ...
                <div className="p-6 pt-0 text-center">
                    ...
                    <h3 className="text-xl font-normal text-gray-500 mt-5 mb-6">Are you sure you want to delete this contact?</h3>
